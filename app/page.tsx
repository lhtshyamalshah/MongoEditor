...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return () => controller.abort();
  }, [connection, database, collection, applied, page, pageSize, refresh, after]);
